...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'microservice_two.settings')
django.setup()

def consume():
    from consumer_app.models import Message
    consumer= KafkaConsumer('topicTwo',bootstrap_servers='localhost:9092',auto_offset_reset='earliest',group_id='group_one')
    for msg in consumer:
